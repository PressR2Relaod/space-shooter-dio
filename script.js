...
const insText = document.querySelector('.game-ins');
...
function moveLaser(laser) { //Checando Hitbox
    let laserInterval = setInterval(() => {
        let xPosition = parseInt(laser.style.left);
        let aliens = document.querySelectorAll('.alien');

        aliens.forEach((alien) => {
            if(hitboxLaser(laser, alien)) {
...
//Função de hitbox/colisão
function hitboxLaser(laser, alien) {
